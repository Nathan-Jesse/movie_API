...
class InMemoryMoviesDao implements MoviesDao {
    ...
    private HashMap<Integer, Movie> getMoviesMap() {
        try {
            Reader reader = Files.newBufferedReader(Paths.get("/Users/nathanrodriguez/IdeaProjects/movie_API/src/main/resources/movies.json"));
